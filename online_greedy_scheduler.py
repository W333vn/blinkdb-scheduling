...
class OnlineGreedyScheduler(Scheduler):
  ...
  def handleNewQuery(self, newSystemState):
    ...
    print "Finishes-after-starts relationships: %s" % [[solution[finishesAfterStarts[taskBIdx][taskAIdx]] for taskBIdx in xrange(numTasks)] for taskAIdx in xrange(numTasks)]
